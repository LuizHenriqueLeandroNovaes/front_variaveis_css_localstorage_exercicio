...
const englishText =
  ...
  const flagBrazil = document.querySelector("#brasil-flag");
  const flagEngland = document.querySelector("#england-flag");
  ...
  flagBrazil.addEventListener("click",()=>{
    toggleLanguage("pt-br")
  });

  flagEngland.addEventListener("click",()=>{
    toggleLanguage("en")
  });
  ...
  function applyCurrentTheme(){
    ...
    if(!currentTheme || currentTheme === "light"){
      ...
      root.style.setProperty("--header-footer-text-color","white");
      return;
    }
